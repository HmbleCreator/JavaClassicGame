...
public class Graphics3D {
    ...
    public final void drawCommandList(Texture texture, int i, int i2, FigureLayout figureLayout, Effect3D effect3D, int[] iArr) {
    }

    public final void drawCommandList(Texture[] textureArr, int i, int i2, FigureLayout figureLayout, Effect3D effect3D, int[] iArr) {
    }

    public final void drawFigure(Figure figure, int i, int i2, FigureLayout figureLayout, Effect3D effect3D) throws IllegalStateException {
    }
    ...
    public final void renderFigure(Figure figure, int i, int i2, FigureLayout figureLayout, Effect3D effect3D) throws IllegalStateException {
    }

    public final void renderPrimitives(Texture texture, int i, int i2, FigureLayout figureLayout, Effect3D effect3D, int i3, int i4, int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
    }
}
